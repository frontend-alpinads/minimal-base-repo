  ...
  return (
    <div className="grid w-full grid-cols-[2fr_2fr_1fr] gap-6 overflow-hidden max-lg:flex max-lg:flex-col lg:items-center lg:gap-8">
      ...
      {isDesktop ? (
        ...
        >
          <button className="group flex flex-1 cursor-pointer items-center gap-4 text-start">
            <div className="bg-background/20 group-hover:bg-primary/10 border-foreground/10 flex size-14 items-center justify-center border transition-all duration-300">
              <CalendarDotsIcon className="text-foreground size-6" />
            </div>
      ...
      >
        ...
        >
          <div className="bg-background/20 group-hover:bg-primary/10 border-foreground/10 flex size-14 items-center justify-center border transition-all duration-300">
            <UsersIcon className="text-foreground size-6" />{" "}
          </div>
          {/* Guests Selection */}
