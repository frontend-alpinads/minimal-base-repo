      ...
      <div className="relative mx-auto flex w-full flex-col items-center gap-14 lg:gap-20">
        ...
        <div className="mx-auto flex w-full flex-col items-center gap-4 px-4 lg:grid lg:grid-cols-2 lg:gap-20 lg:px-5">
          <div className="contents flex-col gap-4 lg:flex">
            <h2 className="text-accent py-2 text-base leading-[150%] tracking-[5%] uppercase max-lg:text-center lg:mb-1">
              - {gallery.badge} -
            </h2>
            <p className="font-title text-display-2 text-primary font-normal max-lg:text-center">
              {titleParts[0]}
              {titleParts[1]}
            </p>
          </div>

          <p className="mx-auto w-full max-w-360 text-base leading-normal -tracking-[1%] max-lg:text-center">
            {gallery.description}
          </p>
        </div>
        ...
        <div className="w-full px-4 lg:px-5">
          <div className="overflow-x-auto pb-5 max-lg:-mx-4 lg:pb-6">
            {/**  <div className="max-lg:px-4 lg:w-fit">
              <GalleryTabs
                activeTab={activeTab}
