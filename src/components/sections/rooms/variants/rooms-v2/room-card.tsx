  ...
  return (
    <div className="bg-card relative flex w-full flex-col overflow-hidden">
      ...
      >
        ...
        <div className="bg-accent text-background font-title absolute right-0 bottom-0 z-10 flex items-center px-3 py-2 text-base leading-normal lg:gap-3 lg:p-3 lg:text-xl">
          {common.from}{" "}
      ...
      {/* Content Section */}
      <div className="bg-card text-background flex shrink-0 flex-col gap-5 p-5">
        {/* Text Content */}
