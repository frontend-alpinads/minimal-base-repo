  ...
  return (
    <div className="relative">
      <div className="overflow-hidden px-4 lg:px-20" ref={emblaRef}>
        <div className="-ml-4 flex lg:-ml-6">
          {slides.map((slide, index) => (
            <div
              key={index}
              className="flex-[0_0_100%] pl-4 lg:flex-[0_0_60%] lg:pl-6"
            >
              {slide}
            </div>
          ))}
      ...
      <div className="mt-8 flex justify-center gap-4">
        <button
          onClick={scrollPrev}
          className="bg-primary/0 hover:bg-primary/10 border-primary flex size-12 cursor-pointer items-center justify-center rounded-full border transition-all disabled:pointer-events-none disabled:opacity-50"
