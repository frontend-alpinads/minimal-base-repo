...
export function TestimonialCard({
  ...
  return (
    <div className="text-foreground max-lg:bg-background flex h-full flex-col gap-8 max-lg:items-center max-lg:border max-lg:px-4 max-lg:py-5 max-lg:text-center">
      <div>
        <div className="text-star mb-4 flex gap-1 max-lg:justify-center">
          {renderStars()}
        </div>
        {/* Testimonial Text */}
        <p className="text-xl leading-[150%] lg:text-2xl lg:leading-[140%]">
          <span
            className={cn(
