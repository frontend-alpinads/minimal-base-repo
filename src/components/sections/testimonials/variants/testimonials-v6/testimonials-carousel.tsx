  ...
  return (
    <div className="relative">
      ...
      <div className="mt-8 flex justify-center gap-4">
        <button
          onClick={scrollPrev}
          className="bg-primary/0 hover:bg-primary/3 border-primary flex size-12 cursor-pointer items-center justify-center rounded-full border transition-all disabled:pointer-events-none disabled:opacity-50"
