...
export function RoomCard({ room }: { room: Room }) {
  ...
  return (
    <div className="bg-background relative flex h-105 w-full flex-col overflow-hidden lg:h-160">
      {/* Image Container */}
      <RoomCardCarousel
      ...
      >
        ...
        <div className="text-background absolute top-3 left-3 z-10 flex flex-wrap gap-3 lg:gap-6">
          <div className="flex items-center gap-3 rounded-sm bg-black/30 px-3 py-2 backdrop-blur-sm">
        ...
        <div className="bg-accent text-primary font-title absolute right-0 bottom-0 z-10 flex items-center px-3 py-2 text-base leading-normal lg:gap-3 lg:p-3 lg:text-xl">
          {common.from}{" "}
      ...
      {/* Content Section */}
      <div className="bg-background text-foreground flex shrink-0 flex-col gap-5 p-5">
        {/* Text Content */}
