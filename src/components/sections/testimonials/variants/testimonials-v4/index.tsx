...
export function TestimonialsV4({ testimonials }: TestimonialsV4Props) {
  const testimonialsContent = useTestimonialsContent();
  const titleParts = testimonialsContent.title.split("\n");

  return (
    <section id="testimonials" className="bg-background">
      <div className="bg-card relative mx-auto flex w-full flex-col gap-14 overflow-hidden py-10 lg:gap-20 lg:py-20">
        {/* Text Contents */}
