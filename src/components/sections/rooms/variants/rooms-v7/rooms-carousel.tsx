    ...
    <div className="relative">
      ...
      <div className="flex flex-col gap-8 px-4 pt-5 lg:flex-row lg:items-center lg:gap-10 lg:px-8 lg:pt-6">
        <div className="flex justify-between gap-4 lg:flex-none lg:shrink-0 lg:gap-10">
          <p className="text-foreground flex items-center justify-center font-light opacity-80 lg:flex-none lg:text-base">
            {getViewingText()
        ...
        <div className="bg-foreground/50 h-1 max-lg:hidden lg:flex-1">
          <div
