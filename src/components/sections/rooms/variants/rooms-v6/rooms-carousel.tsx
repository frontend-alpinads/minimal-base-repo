    ...
    <div className="relative">
      ...
      <div className="flex flex-col gap-8 px-4 pt-5 lg:flex-row lg:items-center lg:gap-10 lg:px-8 lg:pt-6">
        <div className="flex justify-between gap-4 lg:flex-none lg:shrink-0 lg:gap-10">
          <p className="text-foreground flex items-center justify-center opacity-80 lg:flex-none lg:text-base">
            {getViewingText()
          ...
          <div className="flex gap-4 lg:order-last">
            <button
              onClick={scrollPrev}
              className="bg-background hover:bg-background/80 border-primary flex size-12 cursor-pointer items-center justify-center rounded-full border transition-all disabled:pointer-events-none disabled:opacity-50"
        ...
        <div className="bg-foreground/20 h-1 max-lg:hidden lg:order-first lg:flex-1">
          <div
