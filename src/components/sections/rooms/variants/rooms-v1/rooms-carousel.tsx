...
export function RoomsCarousel({ slides, activeTab = "all" }: RoomsCarouselProps) {
    ...
    <div className="relative">
      ...
      <div className="flex flex-col gap-8 px-4 pt-5 lg:flex-row lg:items-center lg:gap-10 lg:px-8 lg:pt-6">
        <div className="flex justify-between gap-4 lg:flex-none lg:shrink-0 lg:gap-10">
          <p className="flex items-center justify-center opacity-80 lg:flex-none lg:text-base">
            {getViewingText()
              .replace("{current}", String(selectedIndex + 1))
              .replace("{total}", String(slides.length))}
          </p>

          <div className="flex gap-4 lg:order-first">
            <button
              onClick={scrollPrev}
              className="bg-background/0 hover:bg-primary/3 border-background flex size-12 cursor-pointer items-center justify-center rounded-full border transition-all disabled:pointer-events-none disabled:opacity-50"
        ...
        <div className="bg-background/50 h-1 max-lg:hidden lg:flex-1">
          <div
